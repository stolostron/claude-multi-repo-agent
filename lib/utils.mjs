...
export function printUsage() {
  ...
  console.log('═══════════════════════════════════════════════════════════════════════════════════');
  console.log('');
  console.log('📋 Usage: zx gen-and-run-tasks.mjs [OPTIONS]');
  console.log('   or:    npm start -- [OPTIONS]');
  console.log('');
  console.log('⚙️  Options:');
  console.log('  📦 --bundle PATH       Specify bundle directory to read target.yml and task.md from');
  ...
  console.log('📦 Bundle mode: When --bundle is specified, reads target.yml and task.md from the bundle directory');
